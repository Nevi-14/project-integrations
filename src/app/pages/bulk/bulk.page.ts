...
if(arti >= 0){
  let articulo =  {
    articulo  : {
      ...
      PORC_DESCUENTO: 0,
      MONTO_DESCUENTO: 0,
      FACTOR_CONVERSION: Math.round(1 /  this.articulosService.articulos[arti].FACTOR_CONVERSION),
      ...
      for(let i = 0 ; i< this.import.length; i++){
        ...
        let articulo =  {
          articulo  : {
            ...
            PORC_DESCUENTO: 0,
            MONTO_DESCUENTO: 0,
            FACTOR_CONVERSION: Math.round(1 /  this.articulosService.articulos[a].FACTOR_CONVERSION),
            CENTRO_COSTO: "001-001-01-01",
            CUENTA_CONTABLE: "00003",
            TIPO_IMPUESTO1: "01",
            TIPO_TARIFA1: "08",
